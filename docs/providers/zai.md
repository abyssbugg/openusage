...
Usage is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch Usage from
Spotlight/Launchpad. Persist it, then restart Usage.
...
3. Enable the Z.ai plugin in Usage settings
