...
describe("ChangelogDialog", () => {
  ...
  it("renders current release with markdown content and GitHub link", async () => {
    ...
    changelogState.releases = [
      {
        ...
        html_url: "https://github.com/datamatics/usage-meter/releases/tag/v1.2.3",
      },
    ]
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/datamatics/usage-meter/releases/tag/v1.2.3",
    )
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/datamatics/usage-meter/pull/123",
    )
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/datamatics/usage-meter/commit/abcdef1",
    )
    ...
    changelogState.releases = [
      {
        ...
        body: null as any,
        published_at: "2024-01-02T00:00:00Z",
        html_url: "https://github.com/datamatics/usage-meter/releases/tag/v1.0.0",
      },
    ]
    ...
    changelogState.releases = [
      {
        ...
        body: "body",
        published_at: null,
        html_url: "https://github.com/datamatics/usage-meter/releases/tag/v1.0.1",
      },
    ]
  ...
  it("shows link to full changelog when multiple releases exist", async () => {
    changelogState.releases = [
      ...
      },
      {
        ...
        html_url: "https://github.com/datamatics/usage-meter/releases/tag/v0.9.0",
      },
    ]
    ...
    expect(openerState.openUrlMock).toHaveBeenCalledWith(
      "https://github.com/datamatics/usage-meter/releases",
    )
  })
    ...
    changelogState.releases = [
      {
        ...
        html_url: "https://github.com/datamatics/usage-meter/releases/tag/v0.1.0",
      },
    ]
