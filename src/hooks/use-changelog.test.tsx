...
describe("useChangelog", () => {
  ...
  it("fetches release by exact currentVersion tag", async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "https://api.github.com/repos/datamatics/usage-meter/releases/tags/v1.2.3",
    )
  })
  ...
  it("falls back between v-prefixed and non-prefixed tags", async () => {
    ...
    expect(fetchMock).toHaveBeenNthCalledWith(
      1,
      "https://api.github.com/repos/datamatics/usage-meter/releases/tags/v1.0.0",
    )
    expect(fetchMock).toHaveBeenNthCalledWith(
      2,
      "https://api.github.com/repos/datamatics/usage-meter/releases/tags/1.0.0",
    )
  })
